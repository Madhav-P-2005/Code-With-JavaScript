...
console.log("Post-Increment :-  ", a1++);   // Output: 5 -> a is now 6

console.log("Pre-Increment  :-  ", ++a1);   // Output: 7 -> a is now 7

console.log("Post-Decrement :-  ", a1--);   // Output: 7 -> a is now 6

console.log("Pre-Decrement  :-  ", --a1);   // Output: 5 -> a is now 5
...
console.log("Greater Than (c > a):", c > a);        

console.log("Less Than (a < c):", a < c); 

console.log("Greater Than or Equal (c >= a):", c >= a);  

console.log("Less Than or Equal (a <= c):", a <= c); 
...
Greater Than or Equal (c >= a) :  true

Less Than or Equal (a <= c) :  true
...
// 1) Equality Operator (==)  :-  The == operator checks for equality only after converting both operands to the same type (type coercion). It evaluates to true if the operands are equal after coercion.


// Example :- 

console.log(5 == '5');                      // Output :-  true (number 5 is equal to string '5' after coercion)

console.log(false == 0);                     // Output :-  true (boolean false is equal to number 0 after coercion)

console.log(null == undefined);                 // Output :-  true



// 2) Strict Equality Operator (===) :-  The == operator checks for equality only after converting both operands to the same type (type coercion). It evaluates to true if the operands are equal after coercion.
...
console.log("Assignment (a = b) : ", a = b); 

console.log("Addition Assignment (a += b) : ", a += b); 

console.log("Subtraction Assignment (a -= b) : ", a -= b); 

console.log("Multiplication Assignment (a *= b) : ", a *= b); 

console.log("Division Assignment (a /= b) : ", a /= b);

console.log("Modulus Assignment (a %= b) : ", a %= b); 

console.log("Exponentiation Assignment (a **= b) : ", a = 2, a **= b);
...
Addition Assignment (a += b) :  4

Subtraction Assignment (a -= b) :  2

Multiplication Assignment (a *= b) :  4

Division Assignment (a /= b) :  2

Modulus Assignment (a %= b) :  0

Exponentiation Assignment (a **= b) :  2 4
...
console.log("Unsigned Right Shift (a >>> 1):", a >>> 1); 
